...
Player.prototype.startMyTurn = function () {
	this.panel.classList.add("active")
}

Player.prototype.endMyTurn = function () {
	this.panel.classList.remove("active")
}

// rollDice will add to turnScore and return false
// to indicate to the game that it's still my turn
// unless dice is 1 and will reset turnscore and return true
Player.prototype.rollDice = function (diceImg) {
...
Player.prototype.onHold = function (finalWinScore) {
